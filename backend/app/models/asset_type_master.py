...
class AssetTypeMaster(Base):
    ...
    category = Column(String(50), ForeignKey("asset_categories.name"), nullable=False, index=True)
    ...
    category_rel = relationship("AssetCategoryMaster", foreign_keys=[category])
