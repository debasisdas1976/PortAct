...
const MIS: React.FC = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      notify.success(editingId ? 'Account updated successfully' : 'Account added successfully');
  ...
  const handleDelete = async (id: number, name: string) => {
    ...
    try { await assetsAPI.delete(id); notify.success('Account deleted successfully'); fetchData(); }
      ...
      <TableContainer component={Paper}>
        <Table>
          <TableHead><TableRow>
            ...
            <TableCell><strong>Maturity Date</strong></TableCell><TableCell align="right"><strong>XIRR</strong></TableCell><TableCell align="center"><strong>Actions</strong></TableCell>
          </TableRow></TableHead>
          <TableBody>
            {assets.length === 0 ? (
