      ...
      <Dialog open={gettingStartedOpen} onClose={() => setGettingStartedOpen(false)} maxWidth="sm" fullWidth>
        ...
        <DialogContent dividers>
          {([
            ...
            <>For broker-linked assets like Stocks and Mutual Funds, head to the <NavLink to="/demat-accounts">Demat/Trading Accounts</NavLink> page under Assets and upload your account statement. Supported sources include <strong>NSDL/CDSL CAS</strong> (PDF), <strong>MF Central CAS</strong> (PDF), <strong>Zerodha</strong>, <strong>Groww</strong>, <strong>ICICI Direct</strong> (CSV/XLSX), and <strong>INDmoney</strong> &amp; <strong>Vested</strong> for US stocks. The system will automatically create the accounts and holdings for you.</>,
